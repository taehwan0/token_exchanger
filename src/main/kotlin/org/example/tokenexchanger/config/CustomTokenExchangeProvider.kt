...
class CustomTokenExchangeProvider(private val jwtGenerator: JwtGenerator) : AuthenticationProvider {
    init {
    ...
    override fun authenticate(authentication: Authentication?): Authentication {
        ...
        val generatedAccessToken = this.jwtGenerator.generate(tokenContext) as OAuth2Token

        val accessToken = accessToken<OAuth2Token>(
